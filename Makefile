...
monkey:
	clang -o .bin/monkey monkey.c repl/repl.c token/token.c lexer/lexer.c parser/parser.c parser/parselets.c evaluator/evaluator.c object/object.c utils/argv.c ast/ast.c utils/list.c $(FLAGS)
